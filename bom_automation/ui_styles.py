THEME_CSS = r'''
        ...
        .stDownloadButton > button[kind="primary"] {
            ...
            color: #ffffff !important;
            border: 1px solid #2457cd !important;
        }
        .stDownloadButton > button[kind="primary"]:hover {
            background: #2457cd !important;
            color: #ffffff !important;
            border: 1px solid #1f4ebc !important;
        }
        ...
        .cx-popup-table-wrap {
            ...
            scrollbar-color: #7f98bc #e5edf8;
            background: #ffffff;
            box-shadow: inset 0 -10px 12px -12px rgba(28, 53, 90, 0.45);
        }
        .cx-popup-table-wrap::-webkit-scrollbar {
            width: 13px;
            height: 13px;
        }
        .cx-popup-table-wrap::-webkit-scrollbar-track {
            background: #e5edf8;
        ...
        .cx-results-title-wrap .cx-title {
            margin: 0;
        }
        .cx-results-gap {
            height: 0;
        ...
        [class*="st-key-card_hit_grid_"] {
            margin-top: -164px;
            margin-bottom: -4px;
        }
        [class*="st-key-card_hit_list_"] {
            margin-top: -190px;
            margin-bottom: -4px;
        }
        ...
        [class*="st-key-card_hit_list_"] .stButton > button:focus {
            background: rgba(47, 98, 216, 0.04) !important;
            border: 0 !important;
            color: transparent !important;
            box-shadow: none !important;
        }
        ...
        .st-key-settings_header_card {
            ...
            border-radius: 12px;
            padding: 0.30rem 0.30rem 0.14rem 0.50rem;
            min-height: 55px;
            margin-bottom: 0;
            margin-top: -0.18rem;
        }
        .st-key-settings_header_card [data-testid="stVerticalBlockBorderWrapper"] {
            ...
            box-shadow: none !important;
            background: transparent !important;
            padding: 0.28rem 0.38rem 0.18rem 0.38rem !important;
        }
        .cx-settings-title {
            font-size: 0.74rem;
            letter-spacing: 0.1em;
        ...
        .st-key-results_actions_row,
        .st-key-results_actions_bottom {
            min-height: 2.2rem;
            display: flex;
            align-items: center;
            margin-bottom: -0.35rem;
        ...
        .st-key-results_actions_row .stDownloadButton,
        .st-key-results_actions_row .stButton,
        .st-key-results_actions_row [data-testid="stElementContainer"],
        .st-key-results_actions_bottom .stDownloadButton,
        .st-key-results_actions_bottom .stButton,
        .st-key-results_actions_bottom [data-testid="stElementContainer"] {
            margin-bottom: 0 !important;
            padding-bottom: 0 !important;
        }
        .st-key-results_actions_row .stDownloadButton > button,
        .st-key-results_actions_bottom .stDownloadButton > button {
